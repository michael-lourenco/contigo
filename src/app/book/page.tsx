...
import { History, HistoryData } from "@/components/book/History";
import {
  updateHistory,
  updateUserCredits,
  dbFirestore,
              ...
              {user.credits.value > 0 ? (
                <>
                  ...
                  <BookInfo
                    ...
                    handleLogout={handleLogout}
                  />
                  <BookControls handleSaveClick={handleSaveClick} />
                </>
              ) : (
                  ...
                  <CardContent>
                    ...
                    <div
                      dangerouslySetInnerHTML={{
                        __html: selectedHistory.history,
                      }}
                      className="mt-2"
                    />
                  </CardContent>
