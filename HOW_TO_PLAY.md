...
1. **Iniciar o Jogo:**  
   Abra o jogo no seu PC ou dispositivo Android e inicie uma nova sessão [clicando aqui](https://contigo-math.vercel.app/gameplay):
...
- O jogador pode escolher pular a rodada, caso entenda que que com os números que têm atualmente, não é possível encontrar um resultado no tabuleiro.
